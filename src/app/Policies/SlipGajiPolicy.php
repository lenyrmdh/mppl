...
class SlipGajiPolicy
{
    ...
    {
        return $user->can('view_any_slip::gaji');
    }
    ...
    {
        return $user->can('view_slip::gaji');
    }
    ...
    {
        return $user->can('create_slip::gaji');
    }
    ...
    {
        return $user->can('update_slip::gaji');
    }
    ...
    {
        return $user->can('delete_slip::gaji');
    }
    ...
    {
        return $user->can('delete_any_slip::gaji');
    }
